...
terraform {
  backend "azurerm" {
    subscription_id      = "e2ac6578-a64e-4ce1-ac20-269864032cdf"
    resource_group_name  = "azure-senegal-prod"
    storage_account_name = "tfsenegalprod"
    container_name       = "senegal-hcm-prod"
...
resource "azurerm_network_security_group" "aks_nsg" {
  name                = "aks-nsg-senegal-prod"
  location            = var.location
  resource_group_name = var.resource_group
}

resource "azurerm_network_security_group" "db_nsg" {
  name                = "db-nsg-senegal-prod"
  location            = var.location
  resource_group_name = var.resource_group
}
...
module "kubernetes" {
  ...
  vm_size_custom_np         = "Standard_B8ms"
